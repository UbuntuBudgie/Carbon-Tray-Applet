/*
 * This file was part of budgie-desktop v10.7.x and has now
 * been moved and renamed in this project
 *
 * Copyright Budgie Desktop Developers, Ubuntu Budgie Developers
 *
...
[GtkTemplate (ui="/org/ubuntubudgie/plugins/tray/settings.ui")]
...
public class TrayApplet : Budgie.Applet {
	...
	public TrayApplet(string uuid) {
		...
		settings_schema = "org.ubuntubudgie.plugins.tray";
		settings_prefix = "/org/ubuntubudgie/plugins/instance/tray";
	...
	private void maybe_integrate_tray() {
		...
		if (tray == null) {
			activeUuid = null;
			errorIcon = new TrayErrorIcon(box, _("Carbon Tray failed to initialize."));
			show_all();
			return;
		}
